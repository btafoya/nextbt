  ...
  return (
    <div className="bg-white dark:bg-boxdark border dark:border-strokedark rounded p-6">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
        Configure when you want to receive email notifications for issue activity.
      </p>
      ...
      <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded">
        <p className="text-sm text-blue-800 dark:text-blue-200">
          <strong>Note:</strong> These preferences control which email notifications you receive.
          The minimum severity threshold determines the lowest severity level for which you&apos;ll receive notifications.
          For example, if set to &quot;major&quot;, you&apos;ll only receive notifications for issues with severity &quot;major&quot; or higher.
        </p>
      </div>
    </div>
  );
